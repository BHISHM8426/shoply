...
export default function MainPage() {
  return (
   ...
   <div className='grid grid-cols-12 gap-3 sm:gap-5  my-5  lg:py-14 sm:my-8  lg:mx-auto     max-h-full   '>
    ...
    <div className='  col-span-12 md:col-span-3 lg:col-span-4 xl:col-span-3 2xl:col-span-3 text-center  '>
  ...
  <div className='w-4/5 sm:w-3/5 mx-auto flex flex-col gap-8 py-5 lg:py-16    h-full  rounded-3xl  '>
