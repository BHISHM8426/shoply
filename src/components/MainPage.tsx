...
export default function MainPage() {
  ...
  <div className='w-4/5  md:w-full lg:w-2/3 mx-auto flex flex-col gap-8 py-5  lg:py-16    h-full  rounded-3xl  '>
    ...
    <div className='hidden sm:block'>
      ...
      <li className='bg-white px-4 py-1 text-lg rounded-2xl font-serif  transition ease-in-out delay-150 hover:text-white  hover:-translate-y-1 hover:scale-110 hover:bg-red-400 duration-300 group'> Show All <VscArrowCircleRight className='text-3xl mx-auto transition-transform  group-hover:animate-moveRight'/></li></ul>
